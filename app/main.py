...
# Config from env (set via ConfigMap)
...
app = FastAPI(title="Langflow Chatbot (Mongo-backed)", version="1.0.0")
...
async def chat(req: ChatRequest):
    # Top-K services by subscribers (desc)
    docs = list(
    ...
    # Best-effort extraction (depends on flow)
    try:
